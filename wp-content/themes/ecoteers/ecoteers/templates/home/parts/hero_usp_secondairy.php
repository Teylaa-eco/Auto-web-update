<section class="usp">
	...
	<div class="container mb-50">
		...
		<div class="row justify-center">
			...
			if(get_field('hero')['sub_usps']):

				foreach(get_field('hero')['sub_usps'] as $usp):

			?>

				<div class="display-flex align-center justify-center pr-10 pl-10">
					...
					<span class="size-1 pl-5 text-center">
