...
<div class="wpr-field wpr-field-account">
	...
	<span class="wpr-infoAccount wpr-isValid"><?php esc_html_e( 'RocketCDN is available on local domains and staging sites, Login in to your WP Rocket Account [WP_ROCKET_KEY: ].', 'rocket' ); ?></span>
	<?php else : ?>
